...
public class Day7Test {
    ...
    public void testProgram(String program, String phases, int output) {
        final var longs = Arrays.stream(phases.split(","))
                .mapToLong(Long::parseLong)
                .toArray();
        Assertions.assertEquals(output, Day7.runSimulation(longs, program));
    }
}